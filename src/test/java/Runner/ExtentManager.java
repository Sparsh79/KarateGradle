...
public class ExtentManager {
    ...
    public static void createInstance(String fileName){
        ...
        extent.setSystemInfo("Created By", "Sparsh");
        extent.setSystemInfo("Automation Type", "CXT-API's");
    ...
    public static void  createReport(){
        ...
        if(ExtentManager.getInstance() == null){
            ...
            ExtentManager.createInstance("results/" + "ExtentReport" + formattedDate + ".html");
        }
    }
}
